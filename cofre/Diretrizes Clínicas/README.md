---
tags: [cofre, clinico, referencias, diretrizes]
...
- Quando a memória conflitar com a diretriz, **a diretriz vence**. Precisão > fluência (prioridade recorrente do Rodolpho).
- São **resumos de apoio à produção de conteúdo** — não substituem o texto completo para decisão clínica individual.

## Como adicionar (quando o Rodolpho mandar um PDF e disser "incorpore")
1. Ler o PDF inteiro (`Read` com `pages:`).
2. Criar uma nota-resumo nesta pasta com: **citação completa + DOI**, **escopo** (a quem se aplica / não se aplica), **recomendações** (com grau) e **tabelas-chave** (doses, cortes, alvos, monitorização).
...
- [[Crises Hiperglicêmicas no Adulto — CAD e EHH (consenso ADA-EASD 2024)]] — ⭐ **fonte da emergência hiperglicêmica no ADULTO** (não cobre criança). CAD = glicose **≥200 OU história de diabetes** + BOHB **≥3,0** + pH <7,3 e/ou HCO₃ <18; gravidade por acidose + **cetona** + estado mental (**BOHB >6,0 = grave**); **K <3,5 adia a insulina** (sem exigir sintoma); ânion gap fora; resolução = cetona <0,6 **E** pH ≥7,3 ou HCO₃ ≥18.
- [[Tireoide na Gestação, Preconcepção e Pós-parto (ATA 2026)]] — substitui ATA 2017; TSH fixo **0,1–4,0**, iodo **250 µg/d**, LT4 **+25%/+50%** (sem 12/20), **SCH leve após 1º tri NÃO tratar**, **eutireoidiana TPOAb+ sem LT4** (TABLETS/T4LIFE), hipotiroxinemia 1º tri não tratar, PTU 1º tri + TRAb.
...
- [[Resistência Insulínica no Diabetes Tipo 1 (revisão, Endocrine Reviews 2025)]] — RI no DM1 ("diabetes duplo"); eGDR; CSII > MDI; adjuvantes off-label (cuidado SGLT-2 → cetoacidose).
- [[Insuficiência Ovariana Prematura (revisão, Endocrine Reviews 2025)]] — POI: FSH >25 IU/L + amenorreia ≥4 m, <40 a; ~3,5%; riscos CV/osso/cognição/mortalidade; TRH.
