...
- [ ] **E-mail de suporte na plataforma:** definir e configurar um **e-mail de suporte oficial** visível para os alunos (seção Suporte / Feedback / rodapé). Hoje não há um e-mail de contato configurado — importante ter antes do lançamento aberto.
