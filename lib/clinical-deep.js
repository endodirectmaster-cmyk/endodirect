...
const CANON = {
  ...
  // Desprescrição de AR GLP-1 — área própria desde 2026-08-29. NÃO cabia em
  // Obesidade: aquela área estava com 397.598 de 400.000 caracteres, 2.402 de
  // folga, e o CI vinha avisando que o próximo documento exigiria dividir. É
  // também um assunto com pergunta clínica PRÓPRIA ("posso parar?"), distinta de
  // "como tratar a obesidade" — dividir aqui separa o que já se consultava junto.
  'desprescricao de ar glp-1': 'Desprescrição de AR GLP-1',
  'desprescrição de ar glp-1': 'Desprescrição de AR GLP-1',
  'desprescricao': 'Desprescrição de AR GLP-1',
  'desprescrição': 'Desprescrição de AR GLP-1',
...
const TERMOS = {
  ...
  // Desprescrição de AR GLP-1 (2026-08-29). ⚠️ Mesma lição do DMPT: o CANON casa
  // o RÓTULO, e ninguém escreve "desprescrição de AR GLP-1" ao perguntar —
  // escreve "paciente atingiu a meta, posso suspender a semaglutida?".
  //
  // ⚠️ `reganho` SOZINHO fica de fora: pega reganho pós-bariátrica, que é da
  // Obesidade. `orforglipron` também não entra — é droga de obesidade em geral,
  // e roubaria a área inteira por causa de um ensaio de manutenção.
  'desprescrever': 'Desprescrição de AR GLP-1',
  'reganho de peso': 'Desprescrição de AR GLP-1',
  'peso-alvo': 'Desprescrição de AR GLP-1', 'peso alvo': 'Desprescrição de AR GLP-1',
  // ⚠️ `bate` tolera PLURAL, não ARTIGO NO MEIO. "suspender semaglutida" não casa
  // "posso suspender A semaglutida" — que é exatamente como a pergunta chega ao
  // consultório. Medido: a frase mais provável de todas ("o paciente atingiu a
  // meta, posso suspender a semaglutida?") caía nos 397k de Obesidade e não via
  // uma linha sobre retirada. Mesma família de erro do `tireoidiano`.
  'suspender semaglutida': 'Desprescrição de AR GLP-1',
  'suspender a semaglutida': 'Desprescrição de AR GLP-1',
  'parar semaglutida': 'Desprescrição de AR GLP-1',
  'parar a semaglutida': 'Desprescrição de AR GLP-1',
  'suspender tirzepatida': 'Desprescrição de AR GLP-1',
  'suspender a tirzepatida': 'Desprescrição de AR GLP-1',
  'parar tirzepatida': 'Desprescrição de AR GLP-1',
  'parar a tirzepatida': 'Desprescrição de AR GLP-1',
  'suspender o glp-1': 'Desprescrição de AR GLP-1',
  'parar o glp-1': 'Desprescrição de AR GLP-1',
  'retirada do glp-1': 'Desprescrição de AR GLP-1',
  // O gatilho da consulta. `meta de peso` sozinho ficaria de fora de propósito:
  // "qual a meta de peso na obesidade?" é pergunta de tratamento, não de retirada.
  'atingiu a meta de peso': 'Desprescrição de AR GLP-1',
  'meta de peso atingida': 'Desprescrição de AR GLP-1',
  'descontinuacao': 'Desprescrição de AR GLP-1', 'descontinuação': 'Desprescrição de AR GLP-1',
  // ⚠️ `desmame` SOZINHO ROUBAVA: "desmame de prednisona" (Adrenal) e "NPH com
  // prednisona em redução: como ajustar a insulina no desmame?" (Diabetes) caíam
  // aqui. O teste de caminho clínico pegou as duas. Desmame é palavra de qualquer
  // retirada — só vale com o objeto colado. Mesma lição do `enxerto` no DMPT.
  'desmame do glp-1': 'Desprescrição de AR GLP-1',
  'desmame do agonista': 'Desprescrição de AR GLP-1',
  'desmame da semaglutida': 'Desprescrição de AR GLP-1',
  'desmame da tirzepatida': 'Desprescrição de AR GLP-1',
  'desescalada do glp-1': 'Desprescrição de AR GLP-1',
  'step 4': 'Desprescrição de AR GLP-1', 'surmount-4': 'Desprescrição de AR GLP-1',
  'surmount-maintain': 'Desprescrição de AR GLP-1',
  'attain-maintain': 'Desprescrição de AR GLP-1',
