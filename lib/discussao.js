...
${temTab ? `- As TABELAS abaixo vêm do artigo, cada uma precedida de um marcador \`[[TABELA:n]]\`.
...
- Traga só as que sustentam um argumento — não todas por obrigação. Antes do
  marcador, uma frase dizendo o que a tabela mostra; depois, o que se lê nela.` : '- O artigo não tem tabelas extraíveis.'}
