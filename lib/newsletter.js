...
function renderEmail(items, replyTo, unsub, qotd) {
  ...
  const blocos = items.map((a, i) => {
    ...
    return `<tr><td class="pad" style="padding:24px 0;border-top:2px solid #eef1f6">
      ...
      ${a.porque ? `<div class="art-body" style="margin-top:16px;background:#f4f7fc;border-left:4px solid #2563eb;border-radius:10px;padding:14px 16px;font-size:16px;color:#374151;line-height:1.65;text-align:justify"><b style="color:#13294b">Por que importa:</b> ${esc(a.porque)}</div>` : ''}
