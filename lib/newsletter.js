...
function renderEmail(items, replyTo, unsub) {
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#eef1f6"><tr><td class="outer" align="center" style="padding:24px 12px">
    <table role="presentation" class="container" width="700" cellpadding="0" cellspacing="0" style="width:100%;max-width:700px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 2px 12px rgba(16,33,67,.08)">
      <tr><td class="pad" style="background:#13294b;padding:30px 36px">
        <div style="color:#ffffff;font-size:27px;font-weight:800;letter-spacing:.2px;font-family:${FONT}">Endodirect</div>
        <div style="color:#b9c6dc;font-size:15px;margin-top:6px;font-family:${FONT}">Os artigos mais relevantes do dia · ${dateBR()}</div>
      </td></tr>
