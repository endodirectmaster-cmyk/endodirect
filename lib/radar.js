...
const { candidatos: pmcCandidatos, consultarPmcids, aplicar: aplicarPmc } = require('./pmc-repescagem');
...
async function runRadar() {
  ...
  const repescados = aplicarPmc(merged.payload.radar_avisos, mapaPmc);
