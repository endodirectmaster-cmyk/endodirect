...
Responda SOMENTE com JSON neste formato exato:
{"resumo":"<3 a 5 linhas com o que o comunicado diz de mais importante, em portugues claro>","porque":"<1-2 frases: por que importa na pratica clinica no Brasil>"}
Regras: use apenas o conteudo fornecido; nao invente numeros nem afirmacoes; portugues do Brasil.`;
  try {
    const r = await fetch('https://api.anthropic.com/v1/messages', {
