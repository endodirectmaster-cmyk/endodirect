...
async function sendSupportEmail(data) {
  try {
    ...
    const from = process.env.SUPPORT_FROM || process.env.NEWSLETTER_FROM || 'Endodirect <newsletter@endodirect.com.br>';
    const to = recipients();
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td align="center">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#fff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb">
          ...
          <tr><td style="padding:18px 24px">
            ...
            <p style="margin:0 0 6px;font-size:14px;color:#374151"><b>E-mail:</b> ${esc(email)}</p>
            ...
            <p style="margin:16px 0 0;font-size:12px;color:#9ca3af">Responda este e-mail para falar direto com o aluno (reply-to definido).</p>
          </td></tr>
